...
let pattern_2 = "são";
let pattern_3 = "bra"
let pattern_4 = "Corinthians"
let pattern_5 = "campeão"
let text = "fabricio e fabricio são xaras"
let text2 = "Corinthians é Bi campeão mundial"
//pos:      0          11
...
console.log(`Occurrence indices for Corinthians ${pattern_4}: `, str_search.trivial(pattern_4, text2));
console.log(`Occurrence indices for campeão ${pattern_5}: `, str_search.trivial(pattern_5, text2));


console.log(str_search.build_char_map("fabricio"));
console.log(str_search.build_char_map("Corinthians"));
